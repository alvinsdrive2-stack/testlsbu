...
export const CERTIFICATE_FIELDS: CertificateFieldConfig[] = [
  ...
  { key: "name",     label: "Nama",             x: 969, y: 730,  fontSize: 1100, color: "#012A4D", align: "middle", fontWeight: "normal", fontFamily: "Poppins" },
  { key: "company",  label: "Perusahaan",       x: 950, y: 560,  fontSize: 800,  color: "#012A4D", align: "middle", fontWeight: "normal", fontFamily: "Poppins" },
  { key: "npwp",     label: "NPWP",             x: 962, y: 641,  fontSize: 500,  color: "#012A4D", align: "middle", fontWeight: "normal", fontFamily: "Poppins" },
  { key: "module",   label: "Modul",            x: 986, y: 1044, fontSize: 415,  color: "#0d0d0d", align: "middle", fontWeight: "normal", fontFamily: "Poppins" },
];
